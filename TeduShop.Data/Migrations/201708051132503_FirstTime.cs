namespace TeduShop.Data.Migrations
{
    ...
    public partial class FirstTime : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.ApplicatonUserRoles", "IdentityRole_Id", "dbo.ApplicationRoles");
            DropForeignKey("dbo.ApplicationUserGroups", "UserId", "dbo.ApplicationUsers");
            DropForeignKey("dbo.ApplicatonUserRoles", "ApplicationUser_Id", "dbo.ApplicationUsers");
            ...
            DropIndex("dbo.ApplicatonUserRoles", new[] { "IdentityRole_Id" });
            DropIndex("dbo.ApplicatonUserRoles", new[] { "ApplicationUser_Id" });
            ...
            DropTable("dbo.ApplicatonUserRoles");
